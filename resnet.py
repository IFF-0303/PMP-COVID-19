...
from models import resnet, resnet2p1d, pre_act_resnet, wide_resnet, resnext, densenet, resnet1d
...
def generate_model(opt):
    assert opt.model in [
        'resnet', 'resnet2p1d', 'preresnet', 'wideresnet', 'resnext', 'densenet', 'resnet1d'
    ]
    ...
    elif opt.model == 'resnet1d':
        model = resnet1d.generate_model(model_depth=opt.model_depth,
                                          n_classes=opt.n_classes,
                                          n_input_channels=opt.n_input_channels,
                                          shortcut_type=opt.resnet_shortcut,
                                          conv1_t_size=opt.conv1_t_size,
